...
| **2.5.** Walidacja MF-BB vs PSIM | Replikacja C-blocku PSIM 1:1, MAE ≈ 2.3 V, kalibracja parametrów pasożytniczych | ✅ ukończony |
...
| `demo_bangbang_psim.py` | **Krok 2.5** — replikacja MF-BB 1:1 z C-blockiem PSIM (R_L=0) |
| `porownanie_bb_psim.py` | **Krok 2.5** — nakłada przebiegi Python na PSIM, generuje `wykres_bb_psim_comparison.png` |
...
| `wykres_bb_psim_comparison.png` | Wykres porównawczy MF-BB Python vs PSIM |
| `porownanie_bb_python_vs_psim.png` | Wykres porównawczy z wcześniejszej iteracji |
...
python demo_bangbang_psim.py        # Krok 2.5: replikacja PSIM
python porownanie_bb_psim.py        # Krok 2.5: wykres porównawczy → PNG
```
